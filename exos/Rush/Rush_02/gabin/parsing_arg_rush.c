...
// return parsed str by removing exessive 0 if needed
// if str isnt only composed of numbers :
// return NULL if it contain no numbers or if it's negative.
// tab[0] is the indent for the number of char in str
// tab[1] is for the number of digits in str
// tab[2] is the indent for the number of 0 in str before the important digits
