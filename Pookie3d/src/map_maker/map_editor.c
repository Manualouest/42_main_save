...
/*   Updated: 2024/09/12 18:26:42 by mbirou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	cd_slow_down(t_map_editor *m_edit, struct timeval start_time, int target_fps)
{
	...
	while (1000000 / (end - start) > target_fps)
	{
		gettimeofday(&end_time, NULL);
		end = end_time.tv_sec * 1000000 + end_time.tv_usec;
	}
