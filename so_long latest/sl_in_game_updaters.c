...
/*   Updated: 2024/04/09 00:56:36 by mbirou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	sl_update_moves(t_map_info *map_info)
{
	...
	if (map_info->total_moves < 2147483647)
	{
		...
		write(1, "You have too many moves, please finish.", 39);
	write(1, "\n", 1);
	if (map_info->c_num < 2147483647)
	{
		if (map_info->c_num > 0)
		{
		...
		write(1, "Sorry, the number of flowers is currently too big.", 50);
	write(1, "\n", 1);
}
