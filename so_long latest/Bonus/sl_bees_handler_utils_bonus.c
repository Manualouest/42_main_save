...
/*   Updated: 2024/04/08 21:02:43 by mbirou           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((bee->bee_pos.x < map_info->size.x - 1 && map_info->map[bee->bee_pos.y]
			[bee->bee_pos.x + 1] == 'E') || (bee->bee_pos.x > 1
			&& map_info->map[bee->bee_pos.y][bee->bee_pos.x - 1] == 'E'))
		return (0);
	if (bee->bee_pos.x < bee->target.x && bee->bee_pos.x < map_info->size.x)
	{
		if (bee->way % 2 != 0)
	...
	if (bee->bee_pos.x - 1 >= 0 && bee->way % 2 == 0)
		sl_link_finder(*bee->img_stack, bee->way + bee->is_angry * 2)
		->img->enabled = 0;
	if (bee->bee_pos.x - 1 >= 0 && bee->way % 2 == 0)
		bee->way ++;
	if (bee->bee_pos.x - 1 >= 0 && --bee->bee_pos.x < map_info->size.x)
		sl_link_finder(*bee->img_stack, bee->way + bee->is_angry * 2)
		->img->enabled = 1;
	return (1);
}
...
{
	if ((bee->bee_pos.y > 1 && map_info->map[bee->bee_pos.y - 1]
			[bee->bee_pos.x] == 'E') || (bee->bee_pos.y < map_info->size.y - 1
			&& map_info->map[bee->bee_pos.y + 1][bee->bee_pos.x] == 'E'))
		return (0);
	if (bee->bee_pos.y < bee->target.y && bee->bee_pos.y < map_info->size.y)
	{
		bee->bee_pos.y ++;
		sl_link_finder(*bee->img_stack, bee->way + bee->is_angry * 2)
		->img->enabled = 1;
